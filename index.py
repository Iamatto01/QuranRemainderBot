...
def main():
    # Initialize the scheduler before the app starts
    scheduler.start()
    ...
    async def set_webhook():
        await app.bot.set_webhook(
            ...
            certificate=open('./certificate.pem', 'rb') if os.path.exists('./certificate.pem') else None
        )
    
    # Run in webhook mode for Azure
    app.run_webhook(
        listen='0.0.0.0',
